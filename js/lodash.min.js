...
!Dt||Dt.global!==Dt&&Dt.window!==Dt&&Dt.self!==Dt||(Bt=Dt);var Dt=Lt&&Lt.exports===zt&&zt,Mt=w();typeof define=="function"&&typeof define.amd=="object"&&define.amd?(Bt.ld=Mt, define(function(){return Mt})):zt&&Lt?Dt?(Lt.exports=Mt).ld=Mt:zt.ld=Mt:Bt.ld=Mt}).call(this);