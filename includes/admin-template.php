...
wp_nonce_field(GIML_NONCE_NAME);
$group_extrafields_arr = "var group_extrafields = ";
$group_extrafields_form = "";
$subgroup_extrafields_arr = "var subgroup_extrafields = ";
$subgroup_extrafields_form = "";
if (has_filter('giml_admin_manage')) {
    $giml_manage_filter = apply_filters('giml_admin_manage', '');
    $group_extrafields_arr .= $giml_manage_filter['groupfields'] . ";";
    $group_extrafields_form = $giml_manage_filter['groupform'];
    $subgroup_extrafields_arr .= $giml_manage_filter['subgroupfields'] . ";";
    $subgroup_extrafields_form = $giml_manage_filter['subgroupform'];
}else{
    $group_extrafields_arr .= "'';";
    $subgroup_extrafields_arr .= "'';";
}
?>
<script>
/*
		 ...
		 <div id="playlist-sections">
		  ...
		  <div id="playlist-columns">
			...
			<div class="form-row">
			 ...
			 <ul>
			 <li>For "download", "audio/video", "link" and "iconic link" type columns, provide two colons "::" separated urls. For eg. http://www.test.com/test1.mp3::http://www.test.com/test2.html</li>
			 <li>To provide title for "audio/video" and "link", separate the url and title with two vertical bars "||" and separate multiple links with two colons "::". For eg. http://www.test.com/test.mp3||Test Audio::http://www.test2.com/test.html||Test Link</li>
                         <li>For "video" type columns, separate the video type and its ID with two vertical bars "||" and separate multiple videos with two colons "::". For eg. youtube||kZ95df2d::vimeo||af546Dz44</li>
			 </ul></font></div>
                            <div class="clear"></div>
			</div>
                            ...
                            <div class="postbox">
                                ...
                                <div class="inside">
                                    <form method="post" action="<? echo $_SERVER['REQUEST_URI'];?>">
                                        <div>Message:</div>
                                        <textarea name="giml-admin-comment" cols="34" rows="10"></textarea>
                                        <div>
